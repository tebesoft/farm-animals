export default class SplashScreen extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      'sheep',
      'images/sheep_spritesheet.png', {
        frameWidth: 244,
        frameHeight: 200,
      }
    );

    this.load.audio('chickenSound', [
      'audio/chicken.ogg',
      'audio/chicken.mp3'
    ]);
    this.load.audio('horseSound', [
      'audio/horse.ogg',
      'audio/horse.mp3'
    ]);
    this.load.audio('pigSound', [
      'audio/pig.ogg',
      'audio/pig.mp3'
    ]);
    this.load.audio('sheepSound', [
      'audio/sheep.ogg',
      'audio/sheep.mp3'
    ]);
  }
